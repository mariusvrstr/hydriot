...
class TSL2591:
    ...
    def __init__(self, gpio_pin, address=ADDR):
        ...
        self.SET_InterruptThreshold(0xff00, 0x0010)
...
class CQRobotLightSensor:
    sensor = None

    def __init__(self, ):
        gpio_pin = 4 # Get from config
        self.sensor = TSL2591(gpio_pin)
    ...
    def read_infrared(self):        
        ...
        infrared_reading = self.sensor.Read_Infrared
        return infrared_reading

    def read_visible(self):        
        visible_reading = self.sensor.Read_Visible
        return visible_reading

    def read_full_spectrum(self):        
        full_spectrum_reading = sensor.Read_FullSpectrum
        return full_spectrum_reading

    def is_available(self):
        reading = -1
        
        if AppConfig().is_light_enabled_sensor() is False:
            return False
